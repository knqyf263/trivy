...
## [0.68.0](https://github.com/knqyf263/trivy/compare/v0.67.0...v0.68.0) (2025-10-24)
...
* add ArtifactID field to uniquely identify scan targets ([#9663](https://github.com/knqyf263/trivy/issues/9663)) ([84a7d9a](https://github.com/knqyf263/trivy/commit/84a7d9a5d6880ef4248ead6bcf2e580deed9107b))
...
* add ReportID field to scan reports ([#9670](https://github.com/knqyf263/trivy/issues/9670)) ([fc976be](https://github.com/knqyf263/trivy/commit/fc976bea480599e52365d306ad8d6031718d4303))
...
* allow ignoring findings by type in Rego ([#9578](https://github.com/knqyf263/trivy/issues/9578)) ([c638fc6](https://github.com/knqyf263/trivy/commit/c638fc646c3c0d56ea50c830a31609badb477c5e))
...
* **cli:** Add trivy cloud suppport ([#9637](https://github.com/knqyf263/trivy/issues/9637)) ([8e6a7ff](https://github.com/knqyf263/trivy/commit/8e6a7ff670c64106d4dea6972ac3f6228f9c6269))
...
* **fs:** change artifact type to repository when git info is detected ([#9613](https://github.com/knqyf263/trivy/issues/9613)) ([cff91ac](https://github.com/knqyf263/trivy/commit/cff91acdef91fbce22306a72000c43a26ac8d79b))
...
* **image:** add RepoTags support for Docker archives ([#9690](https://github.com/knqyf263/trivy/issues/9690)) ([a9a3031](https://github.com/knqyf263/trivy/commit/a9a3031675150e70a32df8d55b4aec2c4a33084b))
...
* **misconf:** include map key in manifest snippet for diagnostics ([#9681](https://github.com/knqyf263/trivy/issues/9681)) ([197c9e1](https://github.com/knqyf263/trivy/commit/197c9e1dce450737fc705184eed4c24fcfc1ecc1))
...
* **misconf:** Update Azure Container Schema ([#9673](https://github.com/knqyf263/trivy/issues/9673)) ([43a7546](https://github.com/knqyf263/trivy/commit/43a7546d31f2cc8dd5f8d68f82822aff1bddc4d2))
...
* **sbom:** use SPDX license IDs list to validate SPDX IDs  ([#9569](https://github.com/knqyf263/trivy/issues/9569)) ([35db88c](https://github.com/knqyf263/trivy/commit/35db88c81cc5cdb8ab25362aea455c586d2e1d32))
...
* add `buildInfo` for `BlobInfo` in `rpc` package ([#9608](https://github.com/knqyf263/trivy/issues/9608)) ([6def66e](https://github.com/knqyf263/trivy/commit/6def66e002427eadcc6dbabe56b01c37c1eae075))
...
* **aws:** use `BuildableClient` insead of `xhttp.Client` ([#9436](https://github.com/knqyf263/trivy/issues/9436)) ([fa6f1bf](https://github.com/knqyf263/trivy/commit/fa6f1bfecfb68c29ad4684a6fb5d86948c7d6887))
...
* close all opened resources if an error occurs ([#9665](https://github.com/knqyf263/trivy/issues/9665)) ([fa6f779](https://github.com/knqyf263/trivy/commit/fa6f77902234f5bee70287a841e8cfa42ca4a505))
...
* **java:** update order for resolving package fields from multiple demManagement ([#9575](https://github.com/knqyf263/trivy/issues/9575)) ([e286c5e](https://github.com/knqyf263/trivy/commit/e286c5e207b6d8a1ef01f3f634f874e2e3d4c0f0))
...
* **license:** don't normalize `unlicensed` licenses into `unlicense` ([#9611](https://github.com/knqyf263/trivy/issues/9611)) ([09162e5](https://github.com/knqyf263/trivy/commit/09162e52ecf2a3e7a65dcf4ab2c2ea43ee6f5437))
...
* **nodejs:** fix npmjs parser.pkgNameFromPath() panic issue ([#9688](https://github.com/knqyf263/trivy/issues/9688)) ([231492d](https://github.com/knqyf263/trivy/commit/231492db52ce69c8d9186b039b038bf0153f8dfa))
...
* **nodejs:** use the default ID format to match licenses in pnpm packages. ([#9661](https://github.com/knqyf263/trivy/issues/9661)) ([804ea4a](https://github.com/knqyf263/trivy/commit/804ea4aa575e486fd888f59c9ceb495857b57f8c))
...
* restore compatibility for google.protobuf.Value ([#9559](https://github.com/knqyf263/trivy/issues/9559)) ([aeeb2a1](https://github.com/knqyf263/trivy/commit/aeeb2a1f842b56147996b600bd34db2cf05cd28e))
...
* **sbom:** add `buildInfo` info as properties ([#9683](https://github.com/knqyf263/trivy/issues/9683)) ([2c43425](https://github.com/knqyf263/trivy/commit/2c43425e051d80d45169a2c675dba79caa91b1e7))
...
* Trim the end-of-range suffix ([#9618](https://github.com/knqyf263/trivy/issues/9618)) ([e18b038](https://github.com/knqyf263/trivy/commit/e18b038ee2dce6c239246592fcef769853c11660))
...
* Use `fetch-level: 1` to check out trivy-repo in the release workflow ([#9636](https://github.com/knqyf263/trivy/issues/9636)) ([6e53686](https://github.com/knqyf263/trivy/commit/6e53686526ef21e8a347fc07daa2f628e24eb9e5))
* use context for analyzers ([#9538](https://github.com/knqyf263/trivy/issues/9538)) ([b885d3a](https://github.com/knqyf263/trivy/commit/b885d3a3693a62bd2f506aeb238025242735ef1d))
...
* using SrcVersion instead of Version for echo detector ([#9552](https://github.com/knqyf263/trivy/issues/9552)) ([66479f0](https://github.com/knqyf263/trivy/commit/66479f050dc1f0faa314c5a4b9159f38bb1f146b))
* validate backport branch name ([#9548](https://github.com/knqyf263/trivy/issues/9548)) ([f0fd432](https://github.com/knqyf263/trivy/commit/f0fd432a7aeced7cca1acab5a52d72cd960e7171))
* **vex:** don't  suppress vulns for packages with infinity loop ([#9465](https://github.com/knqyf263/trivy/issues/9465)) ([78f0d4a](https://github.com/knqyf263/trivy/commit/78f0d4ae0378f81940a5faa6497e6905cb5d034a))
* **vex:** don't use reused BOM ([#9604](https://github.com/knqyf263/trivy/issues/9604)) ([7422cc7](https://github.com/knqyf263/trivy/commit/7422cc7168ab917ec96b75de784be72e9b6bdb2e))
